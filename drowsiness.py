        ...
        for subject in subjects:
            ...
            if ear < thresh:
                ...
                if flag == frame_check:
                    ...
                    #GSM code to send message
                    ser.write(('AT+CMGF=1\r').encode('utf-8'))
                    print("Text mode enabled...")
                    time.sleep(3)
                    ser.write(('AT+CMGS="9035028848"\r').encode('utf-8'))
                    msg="Alert: DROWSINESS DETECTED: CAR NUMBER=KA 03 ME 8089..."
                    print("sending message....")
                    time.sleep(3)
                    ser.write((msg+chr(26)).encode('utf-8'))
                    time.sleep(3)
                    print("message sent...")
